...
namespace RazorView.Properties {
    ...
    public sealed partial class Settings {
        ...
        public List<string> VisualizerAssembliesList {
            get {
				return string.IsNullOrWhiteSpace(VisualizerAssemblies) ? new List<string>() : new List<string>(VisualizerAssemblies.Split(';'));
			} set {
				VisualizerAssemblies = string.Join(";", value);
			}
        }
    }
}