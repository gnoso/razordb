...
namespace RazorDB
{
	public class JournalWriter
	{
        ...
        // Add an item to the journal. It's possible that a thread is still adding to the journal while another thread is closing the journal.
        // In that case, we return false and expect the caller to loop the operation on another journal instance.
