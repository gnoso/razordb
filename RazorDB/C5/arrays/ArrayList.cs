...
, IStack<T>, IQueue<T>
#endif
  {
    ...
    //TODO: wonder if we should save some memory on none-view situations by putting these three fields into a single ref field?
    ...
    struct Position
    {
      ...
      public Position(ArrayList<T> v, bool left) {
        view = v;
